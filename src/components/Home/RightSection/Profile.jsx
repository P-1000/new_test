...
const Profile = () => {
  ...
  return (
    <div className="w-[16rem]  hidden md:block lg:max-[xl]:w-[14rem]  ">
      <div className="border p-3 flex items-center flex-col rounded-xl shadow-lg bg-gray-100 cursor-pointer hover:scale-105 transition ease-in hover:bg-white hover:shadow-xl">
        <div className="gap-20 text-lg font-medium text-black/80 flex items-center justify-between">
          ...
          <DropdownButton login={userProfile ? true : false} cla/>
          {/* </button> */}
        </div>
