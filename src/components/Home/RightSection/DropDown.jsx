  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className={`p-2 mt-2 mx-[5rem] transition-transform ${
      ...
      {isDropdownOpen && (
        ...
        animate={{y:0 ,opacity:1 , }}
          className="origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 transition-opacity transform translate-y-0 opacity-100"
          role="menu"
